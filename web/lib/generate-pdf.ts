...
export async function generateInspectionPDF(data: InspectionPDFData): Promise<jsPDF> {
  ...
  autoTable(doc, {
    ...
    body: [
      [
        { content: "Overall Status", styles: { fontStyle: "bold" as const, fillColor: LIGHT_GRAY, textColor: DARK_GRAY } },
  ...
  doc.setTextColor(...MID_GRAY);
  const notes = [
    "This report was generated by CatWatch AI-powered inspection system using Qwen2-VL visual language model analysis.",
    ...
    "Component status follows Caterpillar inspection standards: Good (acceptable condition), Fair (needs monitoring/attention), Poor (immediate action required).",
