  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
      <div>
        ...
        <span style={{ color: "var(--text-dim)", fontSize: 13, margin: "0 8px" }}>/</span>
        <h1 style={{ fontSize: 24, fontWeight: 700, marginTop: 8, marginBottom: 0 }}>Settings</h1>
      </div>

      {/* API Keys section */}
      <section>
        <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 4 }}>API Keys</h2>
        ...
        <div
          className="card"
          style={{ padding: 16, display: "flex", alignItems: "center", justifyContent: "space-between", borderColor: "var(--border-hover)", marginBottom: 24 }}
        >
